...
tmux send-keys "python3 client.py --port=50051" C-m

tmux select-pane -t 2
tmux send-keys "python3 client.py --port=50052" C-m

tmux select-pane -t 3
tmux send-keys "python3 client.py --port=50053" C-m

tmux select-pane -t 4
tmux send-keys "python3 client.py --port=50054" C-m
