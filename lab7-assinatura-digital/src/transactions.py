...
class SolutionTransaction:
    ...
    def from_json(cls, json: bytes | bytearray):
        ...
        loaded = loads(json)
        return cls(loaded["NodeID"], loaded["TransactionID"], loaded["Solution"])
...
class VotingTransaction:
    ...
    def from_json(cls, json: bytes | bytearray):
        ...
        loaded = loads(json)
        return cls(loaded["NodeID"], loaded["VoteID"])


class PubKeyTransaction:
    """Transaction for sharing public keys"""

    def __init__(self, client_id: int, pub_key: str):
        self.client_id = client_id
    ...
    def from_json(cls, json: bytes | bytearray):
        ...
        loaded = loads(json)
        return cls(loaded["NodeID"], loaded["PubKeyMsg"])
